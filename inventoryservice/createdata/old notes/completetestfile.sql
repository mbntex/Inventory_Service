...
CREATE TABLE bookings (
  ...
  booking_start                     DATE,
  booking_end                       DATE,
  listing_price_at_time_booked      INT,
  photo_accuracy_rating             INT,
  listing_uuid                      INT,
  country_id                        VARCHAR(20),
  city_id                           VARCHAR(20),
...
INSERT INTO bookings (booking_uuid, booking_created_at, booking_start, booking_end, listing_price_at_time_booked, photo_accuracy_rating, listing_uuid, country_id, city_id,            user_id)
VALUES               (2222222,      '2018-01-01',        '2018-02-01',   '2018-02-07',      101,                         4,                  100002,     'USA',     'San Francisco',    555),                      
                     (2222221,      '2018-01-02',        '2018-02-09',   '2018-02-12',      98,                          5,                  100002,     'USA',     'San Francisco',    888),   
                     (2222223,      '2018-01-04',        '2018-02-13',   '2018-02-14',      101,                         2,                  100002,     'USA',     'San Francisco',    222),   
                     (2222224,      '2018-01-03',        '2018-01-28',   '2018-02-07',      110,                         NULL,               100001,     'USA',     'New York',         333);  
